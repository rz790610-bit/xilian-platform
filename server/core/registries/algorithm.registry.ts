...
const BUILTIN_ALGORITHMS: AlgorithmRegistryItem[] = [
  {
    ...
    label: 'FFT频谱分析',
    icon: '📊',
    description: 'FFT频谱分析 v3.0 — 多窗函数(hanning/hamming/flattop/rectangular) + 滑动窗口频谱 + 特征频率检测(转频谐波/油膜/轴承倍频/齿轮边带) + 规则故障诊断(不平衡/不对中/松动/轴承边带验证/齿轮对称性) + 多数投票聚合 + ISO 10816/20816评估',
    subcategory: '频谱分析',
    ...
    outputFields: [{"name": "spectrum", "label": "频谱数据(频率+幅值)", "type": "object", "description": "频谱数据"}, {"name": "peaks", "label": "峰值频率(Top20)", "type": "object", "description": "峰值检测结果"}, {"name": "features", "label": "特征频率检测", "type": "object", "description": "转频谐波+油膜+轴承+齿轮"}, {"name": "faultDiagnosis", "label": "规则故障诊断", "type": "object", "description": "不平衡/不对中/松动/轴承/齿轮/油膜"}, {"name": "overallRMS", "label": "总振动量RMS", "type": "number", "description": "RMS"}, {"name": "velocityRMS", "label": "振动速度RMS(mm/s)", "type": "number", "description": "mm/s"}, {"name": "isoEvaluation", "label": "ISO评估", "type": "object", "description": "ISO 10816/20816"}],
    configFields: [{"name": "windowFunction", "label": "窗函数", "type": "string", "default": "hanning", "description": "hanning/hamming/flattop/rectangular"}, {"name": "nfft", "label": "FFT点数", "type": "number", "default": 0, "description": "0=自动(next power of 2)"}, {"name": "frequencyRange", "label": "频率范围", "type": "json", "description": "[fLow, fHigh] Hz"}, {"name": "sliding", "label": "滑动窗口模式", "type": "boolean", "default": false, "description": "启用滑动窗口频谱分析"}, {"name": "windowSize", "label": "窗口长度", "type": "number", "default": 1024, "description": "滑动窗口采样点数"}, {"name": "overlap", "label": "重叠率", "type": "number", "default": 0.5, "description": "0~1"}, {"name": "peakThreshold", "label": "峰值检测阈值", "type": "number", "default": 0.1, "description": "相对最大值比例"}, {"name": "peakMinDistance", "label": "峰值最小距离(Hz)", "type": "number", "default": 5, "description": "Hz"}, {"name": "enableISO", "label": "启用ISO评估", "type": "boolean", "default": true, "description": "ISO 10816/20816"}, {"name": "machineGroup", "label": "机器组别", "type": "string", "default": "group2", "description": "group1~group4"}, {"name": "mountType", "label": "安装方式", "type": "string", "default": "rigid", "description": "rigid/flexible"}, {"name": "enableFeatureDetection", "label": "启用特征频率检测", "type": "boolean", "default": true, "description": "转频谐波+油膜+轴承+齿轮"}, {"name": "enableFaultDiagnosis", "label": "启用规则故障诊断", "type": "boolean", "default": true, "description": "不平衡/不对中/松动/轴承/齿轮/油膜"}, {"name": "shaftRPM", "label": "转速(RPM)", "type": "number", "default": 0, "description": "转速(RPM)"}, {"name": "bearingModel", "label": "轴承型号", "type": "string", "default": "", "description": "轴承型号"}, {"name": "bearingParams", "label": "自定义轴承参数", "type": "json", "description": "{Z,d,D,alpha} 单位mm/度"}, {"name": "gearParams", "label": "齿轮参数", "type": "json", "description": "{Z:齿数}"}],
    ...
    edgeDeployable: true,
    tags: ["FFT", "频谱", "ISO 10816", "ISO 20816", "振动", "特征频率", "故障诊断", "滑动窗口", "轴承", "齿轮"],
    version: 'v3.0.0',
    license: 'builtin',
