...
const BUILTIN_ALGORITHMS: AlgorithmRegistryItem[] = [
  ...
  },
  {
    ...
    configFields: [{"name": "bandpassLow", "label": "带通下限", "type": "number", "default": 0, "description": "带通下限"}, {"name": "bandpassHigh", "label": "带通上限", "type": "number", "default": 0, "description": "带通上限"}, {"name": "filterOrder", "label": "滤波器阶数", "type": "number", "default": 4, "description": "滤波器阶数"}, {"name": "shaftRPM", "label": "转速(RPM)", "type": "number", "default": 0, "description": "转速(RPM)"}, {"name": "bearingModel", "label": "轴承型号", "type": "string", "default": "", "description": "轴承型号"}, {"name": "frequencyMatchTolerance", "label": "频率匹配容差", "type": "number", "default": 0.05, "description": "频率匹配容差"}],
