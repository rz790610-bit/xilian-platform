  ...
  readonly configSchema: ProtocolConfigSchema = {
    ...
    authFields: [
      ...
      { key: 'password', label: '密码', type: 'password', required: false,
        description: '仅 UserName 认证时需要' },
      { key: 'clientCertPem', label: '客户端证书 (PEM)', type: 'string', required: false,
        placeholder: '-----BEGIN CERTIFICATE-----\n...\n-----END CERTIFICATE-----',
        description: 'X509 认证或 SignAndEncrypt 模式需要的客户端证书（PEM 格式）',
        group: 'X509 证书' },
      { key: 'clientKeyPem', label: '客户端私钥 (PEM)', type: 'string', required: false,
        placeholder: '-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----',
        description: '客户端私钥（PEM 格式，与证书配对）',
        group: 'X509 证书' },
      { key: 'serverCertPem', label: '服务器证书 (PEM)', type: 'string', required: false,
