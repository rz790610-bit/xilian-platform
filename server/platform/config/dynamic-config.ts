...
export class DynamicConfigEngine {
  ...
  private registerBuiltinDefaults(): void {
    const defaults: Array<{ key: string; value: unknown; type: ConfigEntry['type']; description: string }> = [
      ...
      { key: 'cognition.grok.model', value: 'grok-3', type: 'string', description: 'Grok 默认模型' },
      { key: 'cognition.grok.maxTokens', value: 4096, type: 'number', description: 'Grok 最大输出 tokens' },
      { key: 'cognition.grok.maxTokensCodeGen', value: 2000, type: 'number', description: '代码生成最大 tokens' },
      { key: 'cognition.grok.maxTokensLabeling', value: 800, type: 'number', description: '标注最大 tokens' },
