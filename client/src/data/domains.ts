...
export const DOMAINS: DomainMeta[] = [
  { id: "base-config",        label: "基础配置",   icon: "Settings",      color: "oklch(0.65 0.1 90)",   tableCount: 11 },
  { id: "asset-management",   label: "资产管理",   icon: "Building2",     color: "oklch(0.75 0.18 170)", tableCount: 4 },
  { id: "device-ops",         label: "设备运维",   icon: "Cpu",           color: "oklch(0.65 0.15 45)",  tableCount: 12 },
  { id: "diagnosis",          label: "诊断分析",   icon: "AlertTriangle", color: "oklch(0.65 0.2 25)",   tableCount: 5 },
  { id: "data-governance",    label: "数据治理",   icon: "Shield",        color: "oklch(0.7 0.12 300)",  tableCount: 12 },
  ...
  { id: "message-task",       label: "消息与任务", icon: "Zap",           color: "oklch(0.6 0.18 200)",  tableCount: 9 },
  { id: "ai-knowledge",       label: "AI知识",     icon: "Brain",         color: "oklch(0.7 0.16 170)",  tableCount: 20 },
  { id: "system-topology",    label: "系统拓扑",   icon: "Network",       color: "oklch(0.65 0.12 200)", tableCount: 9 },
